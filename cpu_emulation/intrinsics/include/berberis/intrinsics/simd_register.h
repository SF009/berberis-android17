...
#endif
SIMD_128_FLOAT_REGISTER_GETTER_SETTER(Float16, _Float16, float16);
SIMD_128_FLOAT_REGISTER_GETTER_SETTER(Float32, float, float32);
SIMD_128_FLOAT_REGISTER_GETTER_SETTER(Float64, double, float64);
