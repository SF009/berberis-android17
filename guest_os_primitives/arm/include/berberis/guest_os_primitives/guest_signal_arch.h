...
CHECK_STRUCT_LAYOUT(Guest_sigaction, 160, 32);
CHECK_FIELD_LAYOUT(Guest_sigaction, guest_sa_sigaction, 0, 32);
CHECK_FIELD_LAYOUT(Guest_sigaction, sa_flags, 32, 32);
CHECK_FIELD_LAYOUT(Guest_sigaction, sa_restorer, 64, 32);
CHECK_FIELD_LAYOUT(Guest_sigaction, sa_mask, 96, 64);
