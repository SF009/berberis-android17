...
# Product configuration for RISC-V64 guest -> ARM64 host translation.
# Keep this package set aligned with the x86_64 configuration.

include frameworks/libs/native_bridge_support/native_bridge_support.mk

BERBERIS_PRODUCT_PACKAGES_RISCV64_TO_ARM64 := \
    ...
    berberis_program_runner_binfmt_misc_riscv64_arm64 \
    berberis_program_runner_riscv64 \
    libberberis_riscv64_arm64

BERBERIS_PRODUCT_PACKAGES_RISCV64_TO_ARM64 += $(NATIVE_BRIDGE_PRODUCT_PACKAGES_RISCV64_READY)

BERBERIS_DISTRIBUTION_ARTIFACTS_RISCV64_TO_ARM64 := \
