...
class GenIntrinsicsTests(unittest.TestCase):
  ...
  def test_get_semantics_player_hook_proto_template_types(self):
    ...
    self.assertEqual(out,
                     ...
                     "Register Foo(Register arg0, "
                                  ...
                                  "uint8_t arg5, "
                                  "MetaValue<Type0>, "
                                  "MetaValue<Type1>)" ) # pyformat: disable
  ...
  def test_gen_interpreter_hook(self):
    ...
    self.assertSequenceEqual(out.getvalue(),
                             ...
                             "Register Foo(Register arg0, Register arg1, MetaValue<Type0>) const "
                             "{\n"
                             "  return "
  ...
  def test_gen_demultiplexer_hook(self):
    ...
    self.assertSequenceEqual(out.getvalue(),
                             ...
                             "      return "
                             "Foo(arg0,arg1,MetaValue<intrinsics::kIdFromType<int32_t>>{});\n"
                             "    case "
                             "intrinsics::TrivialDemultiplexer(intrinsics::kIdFromType<int64_t>):\n"
                             "      CHECK_EQ(intrinsics::kIdFromType<int64_t>, Type0);\n"
                             "      return "
                             "Foo(arg0,arg1,MetaValue<intrinsics::kIdFromType<int64_t>>{});\n"
                             "    default:\n"
  ...
  def test_gen_demultiplexer_hook_multiple_types(self):
    ...
    self.assertSequenceEqual(out.getvalue(),
                             ...
                             "      return "
                             "Foo(arg0,arg1,MetaValue<intrinsics::kIdFromType<int32_t>>{},"
                             "MetaValue<intrinsics::kIdFromType<Float32>>{});\n"
                             ...
                             "      return "
                             "Foo(arg0,arg1,MetaValue<intrinsics::kIdFromType<int64_t>>{},"
                             "MetaValue<intrinsics::kIdFromType<Float64>>{});\n"
                             "    default:\n"
                             "      FATAL(\"Unsupported size\");\n"
                             "  }\n"
                             "}\n\n") # pyformat: disable
