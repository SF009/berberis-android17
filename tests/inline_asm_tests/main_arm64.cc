...
TEST(Arm64InsnTest, UnsignedMaxPairwiseInt8x16) {
  __uint128_t arg1 = MakeUInt128(0x2211221111221122ULL, 0x6655665555665566ULL);
  __uint128_t arg2 = MakeUInt128(0x4433443333443344ULL, 0x8877887777887788ULL);
  __uint128_t res = ASM_INSN_WRAP_FUNC_W_RES_WW_ARG("umaxp %0.16b, %1.16b, %2.16b")(arg1, arg2);
  ASSERT_EQ(res, MakeUInt128(0x6666666622222222ULL, 0x8888888844444444ULL));
}
...
TEST(Arm64InsnTest, UnsignedMinPairwiseInt8x16) {
  ...
  ASSERT_EQ(res, MakeUInt128(0x5555555511111111ULL, 0x7777777733333333ULL));
}
